...
const Event = () => {
    return (
        <Layout>
            ...
            <p className={styles.p}>Мы с радостью приглашаем вас принять участие в <strong>Ежегодном хакатоне по программированию</strong>! Это уникальное мероприятие предоставит вам возможность проявить свои навыки, обменяться опытом с единомышленниками и насладиться атмосферой творчества.</p>
